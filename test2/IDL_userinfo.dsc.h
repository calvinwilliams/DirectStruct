...
_WINDLL_FUNC int DSCSERIALIZE_XML_DUP_userinfo( userinfo *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_DUP_userinfo_V( void *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_XML_userinfo( char *encoding , char *buf , int *p_len , userinfo *pst );
_WINDLL_FUNC int DSCDESERIALIZE_XML_userinfo_V( char *encoding , char *buf , int *p_len , void *pst );

_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_userinfo( userinfo *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_DUP_userinfo( userinfo *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_DUP_userinfo_V( void *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_XML_COMPACT_userinfo( char *encoding , char *buf , int *p_len , userinfo *pst );
_WINDLL_FUNC int DSCDESERIALIZE_XML_COMPACT_userinfo_V( char *encoding , char *buf , int *p_len , void *pst );
...
_WINDLL_FUNC int DSCSERIALIZE_JSON_DUP_userinfo_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_userinfo( char *encoding , char *buf , int *p_len , userinfo *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_userinfo_V( char *encoding , char *buf , int *p_len , void *pv );

_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_userinfo( userinfo *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_DUP_userinfo( userinfo *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_JSON_COMPACT_DUP_userinfo_V( void *pv , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_userinfo( char *encoding , char *buf , int *p_len , userinfo *pst );
_WINDLL_FUNC int DSCDESERIALIZE_JSON_COMPACT_userinfo_V( char *encoding , char *buf , int *p_len , void *pv );
