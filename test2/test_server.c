...
#line 1 "test_server.ecE"
# 1 "test_server.ec"
# 1 "/home/calvin/exsrc/DirectStruct-1.1.0/test2//"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "test_server.ec"
...
# 1 "IDL_userinfo.dsc.h" 1
# 20 "IDL_userinfo.dsc.h"
...
# 21 "IDL_userinfo.dsc.h" 2
# 74 "IDL_userinfo.dsc.h"
typedef struct
{
 int user_id ;
 char user_name[ 16 + 1 ] ;
...
# 8 "test_server.ec" 2
# 1 "IDL_userinfo.dsc.ESQL.eh" 1




# 1 "/root/local/postgresql/include/ecpglib.h" 1
# 10 "/root/local/postgresql/include/ecpglib.h"
# 1 "/root/local/postgresql/include/libpq-fe.h" 1
# 29 "/root/local/postgresql/include/libpq-fe.h"
# 1 "/root/local/postgresql/include/postgres_ext.h" 1
# 29 "/root/local/postgresql/include/postgres_ext.h"
typedef unsigned int Oid;
# 30 "/root/local/postgresql/include/libpq-fe.h" 2
# 41 "/root/local/postgresql/include/libpq-fe.h"
typedef enum
{
...
# 174 "/root/local/postgresql/include/libpq-fe.h"
...
# 228 "/root/local/postgresql/include/libpq-fe.h"
...
extern PQnoticeProcessor PQsetNoticeProcessor(PGconn *conn,
      ...
      void *arg);
# 334 "/root/local/postgresql/include/libpq-fe.h"
...
# 468 "/root/local/postgresql/include/libpq-fe.h"
...
# 11 "/root/local/postgresql/include/ecpglib.h" 2
# 1 "/root/local/postgresql/include/ecpgtype.h" 1
# 41 "/root/local/postgresql/include/ecpgtype.h"
enum ECPGttype
{
...
# 12 "/root/local/postgresql/include/ecpglib.h" 2
# 1 "/root/local/postgresql/include/sqlca.h" 1
# 19 "/root/local/postgresql/include/sqlca.h"
struct sqlca_t
{
 char sqlcaid[8];
 long sqlabc;
 ...
 char sqlerrp[8];
 long sqlerrd[6];
# 39 "/root/local/postgresql/include/sqlca.h"
 char sqlwarn[8];
# 53 "/root/local/postgresql/include/sqlca.h"
 char sqlstate[5];
};

struct sqlca_t *ECPGget_sqlca(void);
# 13 "/root/local/postgresql/include/ecpglib.h" 2
# 49 "/root/local/postgresql/include/ecpglib.h"
void ECPGdebug(int, FILE *);
char ECPGstatus(int, const char *);
char ECPGsetcommit(int, const char *, const char *);
char ECPGsetconn(int, const char *);
char ECPGconnect(int, int, const char *, const char *, const char *, const char *, int);
char ECPGdo(const int, const int, const int, const char *, const char, const int, const char *,...);
char ECPGtrans(int, const char *, const char *);
char ECPGdisconnect(int, const char *);
char ECPGprepare(int, const char *, const char, const char *, const char *);
char ECPGdeallocate(int, int, const char *, const char *);
char ECPGdeallocate_all(int, int, const char *);
...
void sqlprint(void);
# 76 "/root/local/postgresql/include/ecpglib.h"
char ECPGdo_descriptor(int, const char *, const char *, const char *);
char ECPGdeallocate_desc(int, const char *);
char ECPGallocate_desc(int, const char *);
char ECPGget_desc_header(int, const char *, int *);
char ECPGget_desc(int, const char *, int,...);
char ECPGset_desc_header(int, const char *, int);
char ECPGset_desc(int, const char *, int,...);

void ECPGset_noind_null(enum ECPGttype, void *);
char ECPGis_noind_null(enum ECPGttype, void *);
char ECPGdescribe(int, int, char, const char *, const char *,...);
...
# 6 "IDL_userinfo.dsc.ESQL.eh" 2
# 1 "/root/local/postgresql/include/ecpgerrno.h" 1
...
# 1 "/usr/include/errno.h" 1 3 4
# 7 "/root/local/postgresql/include/ecpgerrno.h" 2
# 7 "IDL_userinfo.dsc.ESQL.eh" 2
# 1 "/root/local/postgresql/include/sqlca.h" 1
# 8 "IDL_userinfo.dsc.ESQL.eh" 2
# 16 "IDL_userinfo.dsc.ESQL.eh"
/* exec sql begin declare section */
        
            
            

#line 5007 "test_server.ecE"
 extern int userinfo_user_id ;
 
#line 5007 "test_server.ecE"
 extern short userinfo_user_id_id ;
 
#line 5008 "test_server.ecE"
 extern char userinfo_user_name [ 16 + 1 ] ;
 
#line 5008 "test_server.ecE"
 extern short userinfo_user_name_id ;
 
#line 5009 "test_server.ecE"
 extern char userinfo_email [ 128 + 1 ] ;
 
#line 5009 "test_server.ecE"
 extern short userinfo_email_id ;
/* exec sql end declare section */
#line 5010 "test_server.ecE"

# 37 "IDL_userinfo.dsc.ESQL.eh"
...
# 9 "test_server.ec" 2
# 1 "IDL_userinfo.dsc.LOG.c" 1
# 16 "IDL_userinfo.dsc.LOG.c"
int DSCLOG_userinfo( userinfo *pst )
{
 int index[10] = { 0 } ; index[0] = 0 ;
 printf( "userinfo.user_id[%d]" "\n" , pst->user_id );
 printf( "userinfo.user_name[%s]" "\n" , pst->user_name );
...
int test_server()
{
 ...
 listen_sock = socket( 2 , SOCK_STREAM , IPPROTO_TCP ) ;
 if( listen_sock == -1 )
 {
  printf( "socket failed[%d] , errno[%d]\n" , listen_sock , (*__errno_location ()) );
  return -1;
 }

 on = 1 ;
 setsockopt( listen_sock , 1 , 2 , (void *) & on , sizeof(on) );

 memset( & listen_addr , 0x00 , sizeof(struct sockaddr_in) );
 listen_addr.sin_family = 2;
 listen_addr.sin_addr.s_addr = inet_addr( "127.0.0.1" );
 listen_addr.sin_port = (__extension__ ({ register unsigned short int __v, __x = ((unsigned short)7878); if (__builtin_constant_p (__x)) __v = ((((__x) >> 8) & 0xff) | (((__x) & 0xff) << 8)); else __asm__ ("rorw $8, %w0" : "=r" (__v) : "0" (__x) : "cc"); __v; }));

 nret = bind( listen_sock , (struct sockaddr *) & listen_addr, sizeof(struct sockaddr) ) ;
 if( nret == -1 )
 {
  printf( "bind failed[%d] , errno[%d]\n" , nret , (*__errno_location ()) );
  return -1;
 }
 ...
 { ECPGconnect(__LINE__, 0, "calvin@127.0.0.1:18432" , "'calvin'" , "'calvin'" , 0, 0); }
#line 5149 "test_server.ecE"

 if( (*ECPGget_sqlca()).sqlcode )
 {
  printf( "CONNECT failed[%ld][%s]\n" , (*ECPGget_sqlca()).sqlcode , (*ECPGget_sqlca()).sqlstate );
  return 1;
 }
 else
 {
 ...
 { ECPGtrans(__LINE__, 0, "begin work");}
#line 5161 "test_server.ecE"
 ...
 { ECPGdo(__LINE__, 0, 1, 0, 0, ECPGst_normal, "insert into userinfo values ( $1  , $2  , $3  )", 
	ECPGt_int,&(userinfo_user_id),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, 0 , 0L, 0L, 0L, 
	ECPGt_char,(userinfo_user_name),(long)16 + 1,(long)1,(16 + 1)*sizeof(char), 
	ECPGt_NO_INDICATOR, 0 , 0L, 0L, 0L, 
	ECPGt_char,(userinfo_email),(long)128 + 1,(long)1,(128 + 1)*sizeof(char), 
	ECPGt_NO_INDICATOR, 0 , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 5178 "test_server.ecE"
 ...
 if( nret )
 {
  { ECPGtrans(__LINE__, 0, "rollback work");}
#line 5191 "test_server.ecE"
 ...
 {
  { ECPGtrans(__LINE__, 0, "commit work");}
#line 5205 "test_server.ecE"
