...
#line 1 "IDL_userinfo.dsc.ESQL.ecE"
# 1 "IDL_userinfo.dsc.ESQL.ec"
...
# 23 "/root/local/postgresql/include/libpq-fe.h"
...
# 24 "/root/local/postgresql/include/libpq-fe.h" 2
...
# 14 "/root/local/postgresql/include/ecpglib.h" 2
...
#line 4017 "IDL_userinfo.dsc.ESQL.ecE"
 int userinfo_user_id ;
 
#line 4017 "IDL_userinfo.dsc.ESQL.ecE"
 short userinfo_user_id_id ;
 
#line 4018 "IDL_userinfo.dsc.ESQL.ecE"
 char userinfo_user_name [ 16 + 1 ] ;
 
#line 4018 "IDL_userinfo.dsc.ESQL.ecE"
 short userinfo_user_name_id ;
 
#line 4019 "IDL_userinfo.dsc.ESQL.ecE"
 char userinfo_email [ 128 + 1 ] ;
 
#line 4019 "IDL_userinfo.dsc.ESQL.ecE"
 short userinfo_email_id ;
/* exec sql end declare section */
#line 4020 "IDL_userinfo.dsc.ESQL.ecE"
...
void DSCTRIM_userinfo( userinfo *pst )
{
 {char *p=(pst->user_name)+strlen(pst->user_name)-1; for(;((*p)==' ')&&(p>=(pst->user_name));p--){(*p)='\0';}}
 {char *p=(pst->email)+strlen(pst->email)-1; for(;((*p)==' ')&&(p>=(pst->email));p--){(*p)='\0';}}
 return;
}
