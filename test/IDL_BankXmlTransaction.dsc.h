...
_WINDLL_FUNC int DSCSERIALIZE_XML_DUP_BankXmlTransaction( BankXmlTransaction *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_DUP_BankXmlTransaction_V( void *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_XML_BankXmlTransaction( char *encoding , char *buf , int *p_len , BankXmlTransaction *pst );
_WINDLL_FUNC int DSCDESERIALIZE_XML_BankXmlTransaction_V( char *encoding , char *buf , int *p_len , void *pst );

_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_BankXmlTransaction( BankXmlTransaction *pst , char *encoding , char *buf , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_DUP_BankXmlTransaction( BankXmlTransaction *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCSERIALIZE_XML_COMPACT_DUP_BankXmlTransaction_V( void *pst , char *encoding , char **pp_base , int *p_buf_size , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_XML_COMPACT_BankXmlTransaction( char *encoding , char *buf , int *p_len , BankXmlTransaction *pst );
_WINDLL_FUNC int DSCDESERIALIZE_XML_COMPACT_BankXmlTransaction_V( char *encoding , char *buf , int *p_len , void *pst );
