...
#define DSCSERIALIZE_COMPRESS_BUFSIZE_CommHead	5
...
_WINDLL_FUNC int DSCSERIALIZE_COMPRESS_CommHead( CommHead *pst , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_COMPRESS_CommHead( char *buf , int *p_len , CommHead *pst );
