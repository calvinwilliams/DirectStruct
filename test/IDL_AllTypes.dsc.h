...
#define UNCOMPRESS_INT4(_buf_,_bufoffset_,_int4_)				\
	{									\
		unsigned char	_flag_ = 0 ;					\
		unsigned char	_flag1_ = 0 ;					\
		_int4_ = 0 ;							\
		_flag_ = _buf_[0] & 0xF0 ;					\
		_flag1_ = _buf_[0] & 0x0F ;					\
		memcpy( ((unsigned char*)&_int4_) + (4-_flag1_) , _buf_+1 , _flag1_ );\
		_int4_ = ntohl( _int4_ ) ;					\
		if( _flag_ & 0x10 )						\
		{								\
			_int4_ = -_int4_ ;					\
		}								\
		_bufoffset_+=1+_flag1_; _buf_+=1+_flag1_;			\
	}
#endif
...
#define UNCOMPRESS_UINT4(_buf_,_bufoffset_,_uint4_)			\
	{									\
		...
		_uint4_ = 0 ;							\
		_flag_ = _buf_[0] & 0x0F ;					\
		memcpy( ((unsigned char*)&_uint4_) + (4-_flag_) , _buf_+1 , _flag_ );\
		_uint4_ = ntohl( _uint4_ ) ;					\
		_bufoffset_+=1+_flag_; _buf_+=1+_flag_;				\
	}
#endif
...
#define UNCOMPRESS_INT8(_buf_,_bufoffset_,_int8_)				\
	{									\
		...
		_flag_ = _buf_[0] & 0xF0 ;					\
		_flag1_ = _buf_[0] & 0x0F ;					\
		memcpy( ((unsigned char*)&_int8_) + (8-_flag1_) , _buf_+1 , _flag1_ );\
		__NTOHLL( _int8_ );						\
		if( _flag_ & 0x10 )						\
		{								\
			_int8_ = -_int8_ ;					\
...
#define UNCOMPRESS_UINT8(_buf_,_bufoffset_,_uint8_)				\
	{									\
		...
		_uint8_ = 0 ;							\
		_flag_ = _buf_[0] & 0x0F ;					\
		memcpy( ((unsigned char*)&_uint8_) + (8-_flag_) , _buf_+1 , _flag_ );\
		__NTOHLL( _uint8_ );						\
		_bufoffset_+=1+_flag_; _buf_+=1+_flag_;				\
	}
#endif
...
_WINDLL_FUNC int DSCINIT_AllTypeee( AllTypeee *pst );

_WINDLL_FUNC int DSCNETORDER_AllTypeee( AllTypeee *pst );
_WINDLL_FUNC int DSCHOSTORDER_AllTypeee( AllTypeee *pst );

#define DSCSERIALIZE_COMPACT_BUFSIZE_AllTypeee	4

_WINDLL_FUNC int DSCSERIALIZE_COMPACT_AllTypeee( AllTypeee *pst , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_COMPACT_AllTypeee( char *buf , int *p_len , AllTypeee *pst );

#define DSCSERIALIZE_COMPRESS_BUFSIZE_AllTypeee	5

_WINDLL_FUNC int DSCSERIALIZE_COMPRESS_AllTypeee( AllTypeee *pst , char *buf , int *p_len );
_WINDLL_FUNC int DSCDESERIALIZE_COMPRESS_AllTypeee( char *buf , int *p_len , AllTypeee *pst );
