...
int CallbackOnJsonNode_BankJsonTransaction( int type , char *jpath , int jpath_len , int jpath_size , char *nodename , int nodename_len , char *content , int content_len , void *p )
{
	...
	if( type & FASTERJSON_NODE_BRANCH )
	{
		...
		{
				if( jpath_len == 71 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/AddonMessages/AddonMessage" , jpath_len ) == 0 )
				{if( pst->QueryTransactionDetails.AddonMessages._AddonMessage_count > 3 ) return -8;}
				if( jpath_len == 81 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail" , jpath_len ) == 0 )
				{if( pst->QueryTransactionDetails.TransactionDetails._TransactionDetail_count > 10 ) return -8;}
				if( jpath_len == 85 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionTailDetail" , jpath_len ) == 0 )
	...
	{
		/* version */
		if( jpath_len == 28 && strncmp( jpath , "/BankJsonTransaction/version" , jpath_len ) == 0 )
		{NATOC(content,content_len,pst->version);}
			/* transaction_code */
			if( jpath_len == 52 && strncmp( jpath , "/BankJsonTransaction/ResponseHeader/transaction_code" , jpath_len ) == 0 )
			...
			/* trans_jnlsno */
			if( jpath_len == 48 && strncmp( jpath , "/BankJsonTransaction/ResponseHeader/trans_jnlsno" , jpath_len ) == 0 )
			{NATOI(content,content_len,pst->ResponseHeader.trans_jnlsno);}
			/* response_code */
			if( jpath_len == 49 && strncmp( jpath , "/BankJsonTransaction/ResponseHeader/response_code" , jpath_len ) == 0 )
			{NATOI(content,content_len,pst->ResponseHeader.response_code);}
			/* response_desc */
			if( jpath_len == 49 && strncmp( jpath , "/BankJsonTransaction/ResponseHeader/response_desc" , jpath_len ) == 0 )
			...
			{if( content_len > sizeof(pst->ResponseHeader.response_desc)-1 ) return -7;}}
					/* message_text */
					if( jpath_len == 84 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/AddonMessages/AddonMessage/message_text" , jpath_len ) == 0 )
				...
				/* title_text */
				if( jpath_len == 78 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetailTitle/title_text" , jpath_len ) == 0 )
				...
				/* page_no */
				if( jpath_len == 75 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetailTitle/page_no" , jpath_len ) == 0 )
				{NATOS(content,content_len,pst->QueryTransactionDetails.TransactionDetailTitle.page_no);}
				/* page_size */
				if( jpath_len == 77 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetailTitle/page_size" , jpath_len ) == 0 )
				{NATOS(content,content_len,pst->QueryTransactionDetails.TransactionDetailTitle.page_size);}
					/* trans_date */
					if( jpath_len == 92 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_date" , jpath_len ) == 0 )
					...
					/* trans_time */
					if( jpath_len == 92 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_time" , jpath_len ) == 0 )
					...
					/* outlet_id */
					if( jpath_len == 91 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/outlet_id" , jpath_len ) == 0 )
					...
					/* card_no */
					if( jpath_len == 89 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/card_no" , jpath_len ) == 0 )
					...
					/* trans_amount */
					if( jpath_len == 94 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_amount" , jpath_len ) == 0 )
					...
					/* message_text */
					if( jpath_len == 98 && strncmp( jpath , "/BankJsonTransaction/QueryTransactionDetails/TransactionDetails/TransactionTailDetail/message_text" , jpath_len ) == 0 )
