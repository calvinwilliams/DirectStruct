...
int DSCSERIALIZE_XML_BankXmlTransaction( BankXmlTransaction *pst , char *encoding , char *buf , int *p_len )
{
	...
	len=SNPRINTF(buf,remain_len,"%d",pst->version); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%s",pst->ResponseHeader.transaction_code); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%d",pst->ResponseHeader.trans_jnlsno); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%d",pst->ResponseHeader.response_code); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%s",pst->ResponseHeader.response_desc); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.AddonMessages.AddonMessage[index[3]].message_text); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.TransactionDetailTitle.title_text); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</title_text>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"			<page_no>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%hd",pst->QueryTransactionDetails.TransactionDetailTitle.page_no); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</page_no>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"			<page_size>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%hd",pst->QueryTransactionDetails.TransactionDetailTitle.page_size); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	...
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.TransactionDetails.TransactionDetail[index[3]].trans_date); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</trans_date>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"				<trans_time>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.TransactionDetails.TransactionDetail[index[3]].trans_time); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</trans_time>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"				<outlet_id>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.TransactionDetails.TransactionDetail[index[3]].outlet_id); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</outlet_id>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"				<card_no>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%s",pst->QueryTransactionDetails.TransactionDetails.TransactionDetail[index[3]].card_no); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
	len=SNPRINTF(buf,remain_len,"</card_no>\n"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"				<trans_amount>"); if( len < 0 ) return -1; buf+=len; remain_len-=len;
	len=SNPRINTF(buf,remain_len,"%f",pst->QueryTransactionDetails.TransactionDetails.TransactionDetail[index[3]].trans_amount); XMLESCAPE_EXPAND(buf,len,remain_len); if( len < 0 ) return -1;
...
int CallbackOnXmlNode_BankXmlTransaction( int type , char *xpath , int xpath_len , int xpath_size , char *nodename , int nodename_len , char *properties , int properties_len , char *content , int content_len , void *p )
{
	...
	if( type & FASTERXML_NODE_BRANCH )
	{
		...
		{
				if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/AddonMessages/AddonMessage" , xpath_len ) == 0 )
				{if( pst->QueryTransactionDetails.AddonMessages._AddonMessage_count > 3 ) return -8;}
				if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail" , xpath_len ) == 0 )
	...
	{
		/* version */
		if( strncmp( xpath , "/BankXmlTransaction/version" , xpath_len ) == 0 )
		{NATOC(content,content_len,pst->version);}
			/* transaction_code */
			if( strncmp( xpath , "/BankXmlTransaction/ResponseHeader/transaction_code" , xpath_len ) == 0 )
			...
			/* trans_jnlsno */
			if( strncmp( xpath , "/BankXmlTransaction/ResponseHeader/trans_jnlsno" , xpath_len ) == 0 )
			{NATOI(content,content_len,pst->ResponseHeader.trans_jnlsno);}
			/* response_code */
			if( strncmp( xpath , "/BankXmlTransaction/ResponseHeader/response_code" , xpath_len ) == 0 )
			{NATOI(content,content_len,pst->ResponseHeader.response_code);}
			/* response_desc */
			if( strncmp( xpath , "/BankXmlTransaction/ResponseHeader/response_desc" , xpath_len ) == 0 )
			...
			{if( content_len > sizeof(pst->ResponseHeader.response_desc)-1 ) return -7;}}
					/* message_text */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/AddonMessages/AddonMessage/message_text" , xpath_len ) == 0 )
				...
				/* title_text */
				if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetailTitle/title_text" , xpath_len ) == 0 )
				...
				/* page_no */
				if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetailTitle/page_no" , xpath_len ) == 0 )
				{NATOS(content,content_len,pst->QueryTransactionDetails.TransactionDetailTitle.page_no);}
				/* page_size */
				if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetailTitle/page_size" , xpath_len ) == 0 )
				{NATOS(content,content_len,pst->QueryTransactionDetails.TransactionDetailTitle.page_size);}
					/* trans_date */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_date" , xpath_len ) == 0 )
					...
					/* trans_time */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_time" , xpath_len ) == 0 )
					...
					/* outlet_id */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/outlet_id" , xpath_len ) == 0 )
					...
					/* card_no */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/card_no" , xpath_len ) == 0 )
					...
					/* trans_amount */
					if( strncmp( xpath , "/BankXmlTransaction/QueryTransactionDetails/TransactionDetails/TransactionDetail/trans_amount" , xpath_len ) == 0 )
